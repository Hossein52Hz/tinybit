...
Start talking: [![Gitter](https://img.shields.io/gitter/room/holger1411/tinybit.svg?maxAge=2592000?style=flat-square)](https://gitter.im/holger1411/tinybit)
...
Child Theme Project: [https://github.com/holger1411/tinybit-child](https://github.com/holger1411/tinybit-child)
...
- The `/css/theme.css` and it´s minified little brother `/css/theme.min.css` file(s) provides all styles. It is composed of five different SCSS sets and one variable file at `/sass/theme.scss`:
                  ...
                  - 3 "tinybit/tinybit"; // <--------- Some basic WordPress stylings and needed styles to combine Boostrap and Underscores
...
- Download the tinybit folder from GitHub or from tinybit.com
